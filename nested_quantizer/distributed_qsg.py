...
import qsg_quantizer as quantizer
...
"""
    ...
    for w in range(num_workers):
        qw, sw, qb, sb = worker[w].get_quantized_gradients(x[w], y[w], bucket_size, num_bits)
        server.receive_gradient(qw, sw, qb, sb, bucket_size, num_bits)
