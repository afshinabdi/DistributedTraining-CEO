...
import numpy as np
import quantizers.dithered_quantizer as quantizer
import source_coding.arithmetic_codec as src_codec
import source_coding.discus.nonbinaryDSC as ndsc
...
class AggregationNode:
    ...
    def receive_gradient(self, worker_id: int, qW, sW, qb, sb):
